...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#7aaf43] text-white rounded-full shadow-lg hover:bg-[#6c9b3a] hover:scale-110 transition-all duration-300 group"
    ...
    >
      ...
      {/* Contenedor relativo para forzar el centro geométrico exacto del logo oficial */}
